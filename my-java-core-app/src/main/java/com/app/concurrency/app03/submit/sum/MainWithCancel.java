...
public class MainWithCancel {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        //futureData[0].cancel(false);
        //futureData[1].cancel(false);

        futureData[2].cancel(false);
        futureData[3].cancel(false);
        futureData[4].cancel(false);
